						...
						<div id="kt_aside_menu_wrapper" class="w-100 hover-scroll-overlay-y scroll-ps d-flex" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside, #kt_aside_menu" data-kt-scroll-offset="0">
							<div id="kt_aside_menu" class="menu menu-column menu-title-gray-600 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-icon-gray-400 menu-arrow-gray-400 fw-bold fs-6" data-kt-menu="true">
								<div class="menu-item py-3">
									<a class="menu-link @yield('dashboard')" href="{{url('home')}}" title="Dashboard" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
								...
								<div data-kt-menu-trigger="click" data-kt-menu-placement="right-start" class="menu-item py-3">
									<span class="menu-link @yield('data-controller')" title="Data Controller" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
										<span class="menu-icon">
									...
									<div class="menu-sub menu-sub-dropdown w-225px px-1 py-4">
										...
										<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
											...
											<div class="menu-item">
												<a class="menu-link" href="{{url('kelas/')}}">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
													<span class="menu-title @yield('kelas')">Data Kelas</span>
												</a>
											</div>
											<div class="menu-item">
												<a class="menu-link" href="{{url('kelas_user/')}}">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
									...
									<div class="menu-sub menu-sub-dropdown w-225px px-1 py-4">
										...
										<div class="menu-item">
											<a class="menu-link" href="#">
												...
												<span class="menu-title">Not Implemented Yet</span>
											</a>
										</div>
						...
						<div class="header-container container-xxl">
							...
							<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-20 py-3 py-lg-0 me-3">
								...
								<h1 class="d-flex flex-column text-dark fw-bolder my-1">
									...
									<small class="text-gray-600 fs-6 fw-normal pt-2">Home - @yield('judul')</small>
								</h1>
								<!--end::Heading-->
							</div>
							<!--end::Page title=-->
							...
							<div class="d-flex align-items-center flex-wrap">
								...
								<div class="d-flex align-items-center py-3 py-lg-0">
									...
									<a href="#" class="btn btn-primary" data-bs-target="#" data-bs-toggle="modal">New Goal</a>
								</div>
								<!--end::Action-->
							</div>
							<!--end::Wrapper-->
					...
					<div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container-xxl d-flex flex-column flex-md-row flex-stack">
							...
							<div class="text-dark order-2 order-md-1">
								<span class="text-gray-400 fw-bold me-1">&copy; 2021 <a href="https://esyakl-dev.web.app">E-Syakl</a> | <a href="https://esyakl-dev.web.app">E-Syakl</a> is a product of collaboration between Politeknik Caltex Riau and Advance Pact Sdn Bhd</span>
							</div>
							<!--end::Copyright-->
							<!--begin::Menu-->
