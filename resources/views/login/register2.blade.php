...
<html lang="en">
	<!--begin::Head-->
    <title>E-Syakl | Registration Page</title>
			...
			<div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url(assets/media/illustrations/sigma-1/14.png);">
				...
				<div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
					...
					<a href="../../demo9/dist/index.html" class="mb-12">
						<!-- <img alt="Logo" src="assets/media/logos/logo-1.svg" class="h-80px" /> -->
					</a>
					<!--end::Logo-->
					<!--begin::Wrapper-->
					<div class="w-lg-600px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
						<!--begin::Form-->
						<form class="form w-100" method="post" novalidate="novalidate" action="registerPost" id="kt_sign_up_form">
							...
							<div class="mb-10 text-center">
								...
								<a href="../../demo9/dist/authentication/flows/basic/sign-in.html" class="link-primary fw-bolder">Sign in here</a></div>
								<!--end::Link-->
							</div>
							<!--end::Heading-->
							...
							<div class="fv-row mb-10">
								<label class="form-check form-check-custom form-check-solid form-check-inline">
									<input class="form-check-input" type="checkbox" name="agreeTerms" value="1" />
							...
							<div class="text-center">
								<button type="submit" id="kt_sign_up_submit_modded" class="btn btn-lg btn-primary">
